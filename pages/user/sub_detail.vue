<template>
	<view>
		<cmd-nav-bar :title="typeName + '记录'" backgroundColor="#ff595c" fontColor="#fff" :back="true"></cmd-nav-bar>
...
<script>
	...
	export default {
		...
		onLoad: function (option) {
			...
			this.searchInfo.type = option.typeId
			this.searchInfo.subType = option.subTypeId
