<template>
	<view>
	<cmd-nav-bar title="修改密码" backgroundColor="#ff595c" fontColor="#fff" back="true"></cmd-nav-bar> 
...
<script>
	...
	export default {
		...
		methods: {
			save(e){
				if(!formValidate(this.senddata.oldPassWord,'require') || !formValidate(this.senddata.passWord,'require')
				...
				this.$apiconfig.updatePassWord_f({data:this.senddata}).then(res=>{
